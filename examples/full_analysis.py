...
run_full_analysis(
    ...
    ngram_max_n=3,
    run_cooccurence=True,
    run_word_lengths=True,
    run_positions=True,
)
...
# So running this file will re-generate both '/full_analysis' and 'analysis_summary.md'.
# (minus the comments added to 'analysis_summary.md' for clarity)
